...
# cur = base.cursor()
# base.execute('CREATE TABLE IF NOT EXISTS ' + str(name) + '(info0, info1)')
# base.commit()
# cur.execute('INSERT INTO ' + str(name) + ' VALUES(?, ?)', ('0', '0'))
# base.commit()
# info1 = cur.execute('SELECT info1 FROM line' + str(name)).fetchall()


message_arr = ['Эксель', 'Рынок', 'Пшеница', '20.07.2022', '21.07.2022']
...
if str(message_arr[1]) == 'Рынок':
    ...
    item0 = str('21.07.2022')
    item1 = str('22.07.2022')

    indexstart = info_date.index(item0)
    indexstop = info_date.index(item1)
...
if str(message_arr[1]) == 'Экспорт':
    ...
    cur = base.cursor()
    infoDATE = cur.execute('SELECT date FROM line' + str(count)).fetchall()
    infoCFO = cur.execute('SELECT info0 FROM line' + str(count)).fetchall()
    infoPFO = cur.execute('SELECT info1 FROM line' + str(count)).fetchall()


# message_arr = ['Дашборд', '21.07.2022', '60,1', '60,1', 'Для спидометра', '321,49', '245,46', '555,81', '145,1', '117,5', '95,9', '14527', '407', '2240']
...
#     image_strelka = image_strelka.rotate(13) #
...
#     idraw.text((407, 815), text + '$', font=font, fill='#ffffff')
#     if float(info_psheno[0][0]) == float(message_arr[8]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((389, 851, 483, 879), fill="#c8c4bb", radius=7)
#         idraw.text((406, 858), '0,0$/т', font=font, fill='#ffffff')
#     elif float(info_psheno[0][0]) < float(message_arr[8]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((389, 851, 479, 879), fill="#77a658", radius=7)
#         percent = str(round(float(message_arr[8]) - float(info_psheno[0][0]), 2))
#         percent = percent.replace('.', ',')
#         idraw.text((396, 858), '+' + percent + '$/т', font=font, fill='#ffffff')
#     elif float(info_psheno[0][0]) > float(message_arr[8]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((389, 851, 479, 879), fill="#ce5950", radius=7)
#         percent = str(round(float(message_arr[8]) - float(info_psheno[0][0]), 2))
#         percent = percent.replace('.', ',')
#         idraw.text((396, 858), percent + '$/т', font=font, fill='#ffffff')
#     # Ячмень
...
#     idraw.text((507, 815), text + '$', font=font, fill='#ffffff')
#     if float(info_ichmen[0][0]) == float(message_arr[9]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((489, 851, 583, 879), fill="#c8c4bb", radius=7)
#         idraw.text((506, 858), '0,0$/т', font=font, fill='#ffffff')
#     elif float(info_ichmen[0][0]) < float(message_arr[9]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((489, 851, 583, 879), fill="#77a658", radius=7)
#         percent = str(round(float(message_arr[9]) - float(info_ichmen[0][0]), 2))
#         percent = percent.replace('.', ',')
#         idraw.text((496, 858), '+' + percent + '$/т', font=font, fill='#ffffff')
#     elif float(info_ichmen[0][0]) > float(message_arr[9]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((489, 851, 583, 879), fill="#ce5950", radius=7)
#         percent = str(round(float(message_arr[9]) - float(info_ichmen[0][0]), 2))
#         percent = percent.replace('.', ',')
#         idraw.text((496, 858), percent + '$/т', font=font, fill='#ffffff')
#     # Кукуруза
...
#     idraw.text((603, 814), text + '$', font=font, fill='#ffffff')
#     if float(info_kukuruza[0][0]) == float(message_arr[10]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((590, 851, 676, 879), fill="#c8c4bb", radius=7)
#         idraw.text((606, 858), '0,0$/т', font=font, fill='#ffffff')
#     elif float(info_kukuruza[0][0]) < float(message_arr[10]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((590, 851, 676, 879), fill="#77a658", radius=7)
#         percent = str(round(float(message_arr[10]) - float(info_kukuruza[0][0]), 2))
#         percent = percent.replace('.', ',')
#         idraw.text((596, 858), '+' + percent + '$/т', font=font, fill='#ffffff')
#     elif float(info_kukuruza[0][0]) > float(message_arr[10]):
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=19)
#         idraw.rounded_rectangle((590, 851, 676, 879), fill="#ce5950", radius=7)
#         percent = str(round(float(message_arr[10]) - float(info_kukuruza[0][0]), 2))
#         percent = percent.replace('.', ',')
#         idraw.text((596, 858), percent + '$/т', font=font, fill='#ffffff')
...
#     message_arr_output = str(message_arr[11][:len(message_arr[11]) - 3] + ' ' + message_arr[11][len(message_arr[11]) - 3:len(message_arr[11])])
...
#                     if str(info0[0][0]) != '-':
#                         message_arr_output = message_arr[count][:len(message_arr[count]) - 3] + ' ' + message_arr[count][len(message_arr[count]) - 3:len(message_arr[count])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 12 - 7, PosX - 7 + 80, PosY - 12 - 7 + 31), fill="#67a947", radius=7)
#                         idraw.text((PosX, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # 1 0 0 0
#                         idraw.text((PosX + 1, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # Для жирности
#                         info0output = info0[0][0][:len(info0[0][0]) - 3] + ' ' + info0[0][0][len(info0[0][0]) - 3:len(info0[0][0])]
...
#                     if str(info0[0][0]) != '-':
#                         message_arr_output = message_arr[count][:len(message_arr[count]) - 3] + ' ' + message_arr[count][len(message_arr[count]) - 3:len(message_arr[count])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 12 - 7, PosX - 7 + 80, PosY - 12 - 7 + 31), fill="#ac4540", radius=7)
#                         idraw.text((PosX, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # 1 0 0
#                         idraw.text((PosX + 1, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # Для жирности
#                         info0output = info0[0][0][:len(info0[0][0]) - 3] + ' ' + info0[0][0][len(info0[0][0]) - 3:len(info0[0][0])]
#                         idraw.text((PosX, PosY + 18), info0output, font=font, fill='#ffffff')  # 1 0 0 0
#                     else:
...
#             PosX = PosX + 127
#             if str(message_arr[count + 1]) == '-':
#                 idraw.text((PosX + 22, PosY - 10), '_', font=font, fill="#a8a8a6")  # 0 1 0 0
#                 idraw.text((PosX + 27, PosY - 10), '_', font=font, fill="#a8a8a6")  # Для жирности
#             elif str(info1[0][0]) == '-':
#                 message_arr_output = message_arr[count + 1][:len(message_arr[count + 1]) - 3] + ' ' + message_arr[count + 1][len(message_arr[count + 1]) - 3:len(message_arr[count + 1])]
#                 idraw.rounded_rectangle((PosX - 7, PosY - 7, PosX - 7 + 80, PosY - 7 + 31), fill="#a8a8a6", radius=7)
#                 idraw.text((PosX, PosY), message_arr_output, font=font, fill='black')  # 0 1 0 0
#             else:
#                 if int(info1[0][0]) == int(message_arr[count + 1]):
#                     message_arr_output = message_arr[count + 1][:len(message_arr[count + 1]) - 3] + ' ' + message_arr[count + 1][len(message_arr[count + 1]) - 3:len(message_arr[count + 1])]
#                     idraw.rounded_rectangle((PosX - 7, PosY - 7, PosX - 7 + 80, PosY - 7 + 31), fill="#a8a8a6", radius=7)
...
#                         message_arr_output = message_arr[count + 1][:len(message_arr[count + 1]) - 3] + ' ' + message_arr[count + 1][len(message_arr[count + 1]) - 3:len(message_arr[count + 1])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 12 - 7, PosX - 7 + 80, PosY - 12 - 7 + 31), fill="#67a947", radius=7)
#                         idraw.text((PosX, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # 0 1 0 0
#                         idraw.text((PosX + 1, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # Для жирности
#                         info1output = info1[0][0][:len(info1[0][0]) - 3] + ' ' + info1[0][0][len(info1[0][0]) - 3:len(info1[0][0])]
#                         idraw.text((PosX, PosY + 18), info1output, font=font, fill='#ffffff')  # 0 1 0 0
#                     else:
#                         message_arr_output = message_arr[count + 1][:len(message_arr[count + 1]) - 3] + ' ' + message_arr[count + 1][len(message_arr[count + 1]) - 3:len(message_arr[count + 1])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 7, PosX - 7 + 80, PosY - 7 + 31), fill="#a8a8a6", radius=7)
#                         idraw.text((PosX, PosY), message_arr_output, font=font, fill='black')  # 0 1 0 0
...
#                 idraw.text((PosX + 22, PosY - 10), '_', font=font, fill="#a8a8a6")  # 0 0 1 0
#                 idraw.text((PosX + 27, PosY - 10), '_', font=font, fill="#a8a8a6")  # Для жирности
#             elif str(info2[0][0]) == '-':
#                 message_arr_output = message_arr[count + 2][:len(message_arr[count + 2]) - 3] + ' ' + message_arr[count + 2][len(message_arr[count + 2]) - 3:len(message_arr[count + 2])]
#                 idraw.rounded_rectangle((PosX - 7, PosY - 7, PosX - 7 + 80, PosY - 7 + 31), fill="#a8a8a6", radius=7)
#                 idraw.text((PosX, PosY), message_arr_output, font=font, fill='black')  # 0 0 1 0
#             else:
...
#                         message_arr_output = message_arr[count + 2][:len(message_arr[count + 2]) - 3] + ' ' + message_arr[count + 2][len(message_arr[count + 2]) - 3:len(message_arr[count + 2])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 12 - 7, PosX - 7 + 80, PosY - 12 - 7 + 31), fill="#67a947", radius=7)
#                         idraw.text((PosX, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # 0 0 1 0
#                         idraw.text((PosX + 1, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # Для жирности
#                         info1output = info2[0][0][:len(info2[0][0]) - 3] + ' ' + info2[0][0][len(info2[0][0]) - 3:len(info2[0][0])]
#                         idraw.text((PosX, PosY + 18), info1output, font=font, fill='#ffffff')  # 0 0 1 0
#                     else:
#                         message_arr_output = message_arr[count + 2][:len(message_arr[count + 2]) - 3] + ' ' + message_arr[count + 2][len(message_arr[count + 2]) - 3:len(message_arr[count + 2])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 7, PosX - 7 + 80, PosY - 7 + 31), fill="#a8a8a6", radius=7)
#                         idraw.text((PosX, PosY), message_arr_output, font=font, fill='black')  # 0 0 1 0
...
#                 idraw.text((PosX + 22, PosY - 10), '_', font=font, fill="#a8a8a6")  # 0 0 0 1
#                 idraw.text((PosX + 27, PosY - 10), '_', font=font, fill="#a8a8a6")  # Для жирности
#             elif str(info3[0][0]) == '-':
#                 message_arr_output = message_arr[count + 3][:len(message_arr[count + 3]) - 3] + ' ' + message_arr[count + 3][len(message_arr[count + 3]) - 3:len(message_arr[count + 3])]
#                 idraw.rounded_rectangle((PosX - 7, PosY - 7, PosX - 7 + 80, PosY - 7 + 31), fill="#a8a8a6", radius=7)
#                 idraw.text((PosX, PosY), message_arr_output, font=font, fill='black')  # 0 0 0 1
#             else:
...
#                         message_arr_output = message_arr[count + 3][:len(message_arr[count + 3]) - 3] + ' ' + message_arr[count + 3][len(message_arr[count + 3]) - 3:len(message_arr[count + 3])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 12 - 7, PosX - 7 + 80, PosY - 12 - 7 + 31), fill="#67a947", radius=7)
#                         idraw.text((PosX, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # 0 0 0 1
#                         idraw.text((PosX + 1, PosY - 12), message_arr_output, font=font, fill='#ffffff')  # Для жирности
#                         info1output = info3[0][0][:len(info3[0][0]) - 3] + ' ' + info3[0][0][len(info3[0][0]) - 3:len(info3[0][0])]
#                         idraw.text((PosX, PosY + 18), info1output, font=font, fill='#ffffff')  # 0 0 0 1
#                     else:
#                         message_arr_output = message_arr[count + 3][:len(message_arr[count + 3]) - 3] + ' ' + message_arr[count + 3][len(message_arr[count + 3]) - 3:len(message_arr[count + 3])]
#                         idraw.rounded_rectangle((PosX - 7, PosY - 7, PosX - 7 + 80, PosY - 7 + 31), fill="#a8a8a6", radius=7)
#                         idraw.text((PosX, PosY), message_arr_output, font=font, fill='black')  # 0 0 0 1
...
#                         idraw.text((PosX, PosY), message_arr_output, font=font, fill='black')  # 0 0 0 1
#
#             if count_db_table == 2 or count_db_table == 3 or count_db_table == 4:
#                 PosY += 78
#             if count_db_table == 1:
#                 PosY += 81
#             PosX = 497
...
#             base.commit()
#             cur.execute('INSERT INTO line' + str(count_db_table) + ' VALUES(?, ?, ?, ?)', (message_arr[count], message_arr[count + 1], message_arr[count + 2], message_arr[count + 3]))
#             base.commit()
#             base.execute('CREATE TABLE IF NOT EXISTS DBlinePlot' + str(count_db_table) + '(date, info0, info1, info2, info3)')
#             base.commit()
#             cur.execute('INSERT INTO DBlinePlot' + str(count_db_table) + ' VALUES(?, ?, ?, ?, ?)', (message_arr[1], message_arr[count], message_arr[count + 1], message_arr[count + 2], message_arr[count + 3]))
#             base.commit()
#             count_db_table += 1
#             count += 4
...
#         base = sqlite3.connect('PhotoDashbord.db')
#         cur = base.cursor()
#         image = Image.open("ДашбордПример.jpeg")
#         idraw = ImageDraw.Draw(image)
#         count = 2
#         while count < len(message_arr):
#             message_arr[count] = message_arr[count].replace(',', '.')
...
#         # image.paste(image_strelka, (436, 450), mask=image_strelka)
#         # image.paste(image_strelka, (462, 462))
#         # idraw.arc(xy=(437, 457, 635, 657), start=180, end=360, fill='white', width=3)
#
#         # Фьючерсы свот
#         info_psheno = cur.execute('SELECT info0 FROM Futchersi').fetchall()
#         info_kukuruza = cur.execute('SELECT info1 FROM Futchersi').fetchall()
...
#         # Прогноз пошлины
#         # font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=22)
#         # idraw.text((407, 815), message_arr[12], font=font, fill='#ffffff')  # Phenica
#         # idraw.text((507, 815), message_arr[13], font=font, fill='#ffffff')  # Ichmen
#         # idraw.text((603, 814), message_arr[14], font=font, fill='#ffffff')  # Kukuruza
#         # font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=20)
#         # idraw.rounded_rectangle((389, 851, 479, 879), fill="#86bd69", radius=7)  #
#         # idraw.text((396, 858), message_arr[15], font=font, fill='black')  # Phenica %
#         # idraw.rounded_rectangle((489, 851, 574, 879), fill="#ba534a", radius=7)
#         # idraw.text((496, 858), message_arr[16], font=font, fill='black')  # Ichmen %
#         # idraw.rounded_rectangle((587, 851, 669, 880), fill="#ba534a", radius=7)
#         # idraw.text((596, 858), message_arr[17], font=font, fill='black')  # Kukuruza %
#
#         # СРТ Новороссийск
#         info_CPT = cur.execute('SELECT info0 FROM CPT').fetchall()
#         font = ImageFont.truetype("articulat-cf-demi-bold.ttf", size=23)
...
#         info_plot1 = cur.execute('SELECT info1 FROM Plot1').fetchall()
#         if info_plot1[len(info_plot1) - 2][0] == info_plot1[len(info_plot1) - 1][0]:
#             idraw.text((472, 1039), message_arr[12], font=font, fill='#ffffff')
#         elif info_plot1[len(info_plot1) - 2][0] < info_plot1[len(info_plot1) - 1][0]:
#             idraw.text((472, 1039), message_arr[12], font=font, fill='#77a658')
#         elif info_plot1[len(info_plot1) - 2][0] > info_plot1[len(info_plot1) - 1][0]:
#             idraw.text((472, 1039), message_arr[12], font=font, fill='#ce5950')
#         count_info = len(info_plot1) - 1
#         PosY = 1206 - round(int(info_plot1[count_info][0]) * 160 / 407)
#         idraw.ellipse((672, PosY, 674, PosY + 2), '#fcc666')
#         PosX = 669
...
#         info_plot2 = cur.execute('SELECT info1 FROM Plot2').fetchall()
#         if info_plot2[len(info_plot2) - 2][0] == info_plot2[len(info_plot2) - 1][0]:
#             idraw.text((463, 1138), message_arr[13], font=font, fill='#ffffff')
#         elif info_plot2[len(info_plot2) - 2][0] < info_plot2[len(info_plot2) - 1][0]:
#             idraw.text((463, 1138), message_arr[13], font=font, fill='#77a658')
#         elif info_plot2[len(info_plot2) - 2][0] > info_plot2[len(info_plot2) - 1][0]:
#             idraw.text((463, 1138), message_arr[13], font=font, fill='#ce5950')
#         count_info = len(info_plot2) - 1
#         PosY = 1206 - round((int(info_plot2[count_info][0]) - 1844) / 18)
#         idraw.ellipse((672, PosY, 674, PosY + 2), '#fcc666')
#         PosX = 669
